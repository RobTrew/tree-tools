...
- It avoids duplicated logging of items logged earlier, if the script is called several times in one day.
- (Should, in short, be usable at regular intervals from Hazel, if that suits your workflow)
