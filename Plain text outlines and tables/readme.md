Conversion & prettyprinting [script](https://github.com/RobTrew/tree-tools/blob/master/Plain%20text%20outlines%20and%20tables/mdtreeutil.py) for working with nested and tabular plain text
